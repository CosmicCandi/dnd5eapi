...
if classes.length < 12
  CharacterClass.create(
    [
      { name: 'Barbarian', hit_die: 'd12', skill_amount: 2 },
      { name: 'Bard', hit_die: 'd8', skill_amount: 3 },
      { name: 'Cleric', hit_die: 'd8', skill_amount: 2 },
      { name: 'Druid', hit_die: 'd8', skill_amount: 2 },
      { name: 'Fighter', hit_die: 'd10', skill_amount: 2 },
      { name: 'Monk', hit_die: 'd8', skill_amount: 2 },
      { name: 'Paladin', hit_die: 'd10', skill_amount: 2 },
      { name: 'Ranger', hit_die: 'd8', skill_amount: 3 },
      { name: 'Rogue', hit_die: 'd8', skill_amount: 4 },
      { name: 'Sorcerer', hit_die: 'd8', skill_amount: 2 },
      { name: 'Warlock', hit_die: 'd8', skill_amount: 2 },
      { name: 'Wizard', hit_die: 'd6', skill_amount: 2 }
    ]
  )
end
